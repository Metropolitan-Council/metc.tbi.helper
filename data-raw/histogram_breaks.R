...
histogram_breaks <-
  list(
    ...
    "depart_time_imputed" = list(breaks = c(data.table::as.ITime("00:00"), data.table::as.ITime("06:00"), data.table::as.ITime("09:00"), data.table::as.ITime("12:00"), data.table::as.ITime("15:00"), data.table::as.ITime("18:00"), data.table::as.ITime("21:00"), data.table::as.ITime("24:00")),
                                 labels = c("12-6 AM", "6-9 AM", "9 AM-12 PM", "12-3 PM", "3-6 PM", "6-9 PM", "9 PM-12 AM")),

    "arrive_time" = list(breaks = c(data.table::as.ITime("00:00"), data.table::as.ITime("06:00"), data.table::as.ITime("09:00"), data.table::as.ITime("12:00"), data.table::as.ITime("15:00"), data.table::as.ITime("18:00"), data.table::as.ITime("21:00"), data.table::as.ITime("23:59:59")),
                         labels = c("12-6 AM", "6-9 AM", "9 AM-12 PM", "12-3 PM", "3-6 PM", "6-9 PM", "9 PM-12 AM")),
    ...
    "distance" = list(breaks = c(-10, 1, 3, 5, 10, 20, 50, Inf),
                      labels = c("1 mile or less", "1-3 miles", "3-5 miles", "5-10 miles", "10-20 miles", "20-50 miles", "more than 50 miles")),
